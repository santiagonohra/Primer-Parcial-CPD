 ...
 * Topico: Uso de PThreads para paralelismo
***********************************************************/
#include <stdio.h>
#include <stdlib.h>
#include "mm_lib.h"
...
double *matrizA, *matrizB, *matrizC;   //Matrices de doubles
...
int main(int argc, char **argv){
    ...
    matrizB = matrizA + N*N;
    matrizC = matrizB + N*N;
    inicializar_matrices_double_rnd(matrizA,matrizB,matrizC,N);
    
    /*Impresion matrices a y b 
    printf("Matriz A\n-------\n");
    imprimir_matriz_double(matrizA, N);
    printf("Matriz B\n-------\n");
    imprimir_matriz_double(matrizB, N);*/
    ...
    punto_prueba_inicial();
    multiplicar_matriz_clasica_double(matrizA, matrizB, matrizC, N);
    punto_prueba_final();

    /*
    printf("Matriz C = A x B\n----------\n");
    imprimir_matriz_double(matrizC, N);*/
